...
class Process:
    def __init__(self, data, platform, group):
    ...
    def get_local_keys(self):
        local_keys = ['local_' + key if not key.startswith('local') else key for key in self.keys]
        return local_keys
...
if __name__ == '__main__':
    ...
    process = Process(data, 'platform1', 'group1')
